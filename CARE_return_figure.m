...
% Project:      CARE
% ---------------------------------------------------------------------
% Quantlet:     CARE_return_figure
% ---------------------------------------------------------------------
% Description:  CARE_return_figure plots selected index return time 
%               series from 3 January 2005 to 31 December 2014 
%               (2608 trading days).
% ---------------------------------------------------------------------
% Usage:        CARE_return_figure
% ---------------------------------------------------------------------
% Inputs:       DataIndices.dat
% ---------------------------------------------------------------------
% Output:       Time series of selected index returns
% ---------------------------------------------------------------------
% Keywords:     lCARE, risk management, index, returns, plot,
%               time series, DAX, FTSE100, S&P500 
% ---------------------------------------------------------------------
% See also:     -
% ---------------------------------------------------------------------
